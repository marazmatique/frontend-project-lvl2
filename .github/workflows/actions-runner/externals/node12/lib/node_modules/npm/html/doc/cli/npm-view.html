...
aliases: info, show, v</code></pre>
    ...
    <p>&quot;Person&quot; fields are shown as a string if they would be shown as an
        ...
        the shortened string format. (See <code><a href="../files/package.json.html">package.json(5)</a></code> for more
        on this.)</p>
    ...
    <p>To show the <code>connect</code> package version history, you can do
        this:</p>
    <pre><code>npm view connect versions</code></pre>
