...
<div id="wrapper">
    ...
    <h1><a href="../misc/npm-developers.html">npm-developers</a></h1>
    <p>Developer Guide</p>
...
git+https://user@hostname/project/blah.git#commit-ish</code></pre>
    ...
    <p>See <code><a href="../files/package.json.html">package.json(5)</a></code> for details about what goes in that
        file. At the very
        least, you need:</p>
    <ul>
        <li><p>name:
    ...
    <p>You can use <code>npm init</code> in the root of your package in order to get you
        started with a pretty basic package.json file. See <code><a href="../cli/npm-init.html">npm-init(1)</a></code>
        for
        more info.</p>
    ...
    <h3 id="testing-whether-your-npmignore-or-files-config-works">Testing whether your <code>.npmignore</code> or <code>files</code>
        config works</h3>
