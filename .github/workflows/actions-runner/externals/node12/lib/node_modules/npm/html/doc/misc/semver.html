...
<div id="wrapper">
    ...
    <h1><a href="../misc/semver.html">semver</a></h1>
...
1.2.4-beta.1</code></pre>
    ...
    <ul>
        ...
        <li><code>~1.2.3-beta.2</code> := <code>&gt;=1.2.3-beta.2 &lt;1.3.0</code> Note that prereleases in
            ...
            different <code>[major, minor, patch]</code> tuple.
        </li>
    </ul>
    ...
    <ul>
        ...
        <li><code>^0.0.3-beta</code> := <code>&gt;=0.0.3-beta &lt;0.0.4</code> Note that prereleases in the
            ...
            equal to <code>beta</code>. So, <code>0.0.3-pr.2</code> would be allowed.
        </li>
    </ul>
...
part       ::= nr | [-0-9A-Za-z]+</code></pre>
    ...
    <ul>
        <li><code>loose</code> Be more forgiving about not-quite-valid semver strings.
            ...
            to be the <code>loose</code> param.
        </li>
        <li><code>includePrerelease</code> Set to suppress the <a
                href="https://github.com/npm/node-semver#prerelease-tags">default
            behavior</a> of
    ...
    <ul>
        ...
        <li><code>inc(v, release)</code>: Return the version incremented by the release
            type (<code>major</code>, <code>premajor</code>, <code>minor</code>, <code>preminor</code>,
            <code>patch</code>,
            ...
            <ul>
                <li><code>premajor</code> in one call will bump the version up to the next major
                    ...
                    <code>preminor</code>, and <code>prepatch</code> work the same way.
                </li>
        ...
        <li><code>parse(v)</code>: Attempt to parse a string as a semantic version, returning either
            a <code>SemVer</code> object or <code>null</code>.
        </li>
    </ul>
    ...
    <ul>
        ...
        <li><code>compare(v1, v2)</code>: Return <code>0</code> if <code>v1 == v2</code>, or <code>1</code> if
            <code>v1</code> is greater, or <code>-1</code> if
            <code>v2</code> is greater. Sorts in ascending order if passed to <code>Array.sort()</code>.
        </li>
        <li><code>rcompare(v1, v2)</code>: The reverse of compare. Sorts an array of versions
            in descending order when passed to <code>Array.sort()</code>.
        </li>
        <li><code>diff(v1, v2)</code>: Returns difference between two versions by the release type
            (<code>major</code>, <code>premajor</code>, <code>minor</code>, <code>preminor</code>, <code>patch</code>,
            <code>prepatch</code>, or <code>prerelease</code>),
    ...
    <ul>
        ...
        <li><code>maxSatisfying(versions, range)</code>: Return the highest version in the list
            that satisfies the range, or <code>null</code> if none of them do.
        </li>
        ...
        <li><code>outside(version, range, hilo)</code>: Return true if the version is outside
            ...
            <code>hilo</code> argument must be either the string <code>&#39;&gt;&#39;</code> or
            <code>&#39;&lt;&#39;</code>. (This is
            the function called by <code>gtr</code> and <code>ltr</code>.)
        </li>
