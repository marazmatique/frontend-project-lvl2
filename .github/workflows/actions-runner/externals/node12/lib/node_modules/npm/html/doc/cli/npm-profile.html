...
<div id="wrapper">
    ...
    <h1><a href="../cli/npm-profile.html">npm-profile</a></h1>
...
npm profile disable-2fa</code></pre>
    ...
    <ul>
        ...
        <li><p><code>npm profile enable-2fa [auth-and-writes|auth-only]</code>:
            ...
            <ul>
                ...
                <li><code>auth-and-writes</code>: Requires an OTP at all the times <code>auth-only</code> does, and also
                    requires one when
                    publishing a module, setting the <code>latest</code> dist-tag, or changing access
                    via <code>npm access</code> and <code>npm owner</code>.
                </li>
            </ul>
        </li>
