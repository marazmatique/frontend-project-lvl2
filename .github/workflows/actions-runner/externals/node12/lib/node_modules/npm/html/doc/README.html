...
<div id="wrapper">
    ...
    <h1><a href="cli/npm.html">npm</a></h1>
    <p>a JavaScript package manager</p>
    <p><a href="https://travis-ci.org/npm/cli"><img src="https://img.shields.io/travis/npm/cli/latest.svg"
    ...
    <p><strong>npm is configured to use npm, Inc.&#39;s public registry at
        <a href="https://registry.npmjs.org">https://registry.npmjs.org</a> by default.</strong> Use of the npm public
        registry
        is subject to terms of use available at <a href="https://www.npmjs.com/policies/terms">https://www.npmjs.com/policies/terms</a>.
    </p>
    ...
    <p>There&#39;s a pretty robust install script at
        <a href="https://www.npmjs.com/install.sh">https://www.npmjs.com/install.sh</a>. You can download that and run
        it.</p>
    ...
    <p>Many improvements for Windows users have been made in npm 3 - you will have a better
        experience if you run a recent version of npm. To upgrade, either use <a
...
npm config get globalconfig # defaults to /usr/local/etc/npmrc</code></pre>
    ...
    <p>You can also find npm people in <code>#npm</code> on <a href="https://package.community/">https://package.community/</a>
        or
