...
<div id="wrapper">
    ...
    <h1><a href="../misc/npm-scripts.html">npm-scripts</a></h1>
    ...
    <ul>
        <li>prepublish:
            Run BEFORE the package is packed and published, as well as on local <code>npm
                install</code> without any arguments. (See below)
        </li>
        <li>prepare:
            ...
            below). This is run AFTER <code>prepublish</code>, but BEFORE <code>prepublishOnly</code>.
        </li>
        <li>prepublishOnly:
        ...
        <li>preshrinkwrap, shrinkwrap, postshrinkwrap:
            Run by the <code>npm shrinkwrap</code> command.
        </li>
    </ul>
    ...
    <p>See <a href="https://github.com/npm/npm/issues/10074">https://github.com/npm/npm/issues/10074</a> for a much
        lengthier
...
, &quot;scripts&quot;: { &quot;start&quot; : &quot;bar ./test&quot; } }</code></pre>
    ...
    <p>The package.json fields are tacked onto the <code>npm_package_</code> prefix. So,
        for instance, if you had <code>{&quot;name&quot;:&quot;foo&quot;, &quot;version&quot;:&quot;1.2.5&quot;}</code>
        in your
  ...
  , &quot;test&quot; : &quot;make test&quot;
    ...
    <ul>
        ...
        <li>Try not to use scripts to do what npm can do for you. Read through
            <code><a href="../files/package.json.html">package.json(5)</a></code> to see all the things that you can
            specify and enable
        ...
        <li>Don&#39;t use <code>install</code>. Use a <code>.gyp</code> file for compilation, and
