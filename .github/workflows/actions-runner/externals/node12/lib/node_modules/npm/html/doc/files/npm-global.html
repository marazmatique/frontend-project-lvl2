...
<div id="wrapper">
    ...
    <h1><a href="../files/npm-folders.html">npm-folders</a></h1>
    ...
    <p>Scoped packages are installed the same way, except they are grouped together
        ...
        the package in <code>{prefix}/node_modules/@myorg/package</code>. See <code><a href="../misc/scope.html">scope(7)</a></code>
        for
        more details.</p>
    ...
    <p>See <code><a href="../cli/npm-cache.html">npm-cache(1)</a></code>. Cache files are stored in <code>~/.npm</code>
        on Posix, or
...
+-- node_modules
    ...
    <p>This allows a package maintainer to install all of their dependencies
        ...
        cannot be found elsewhere. See <code><a href="../files/package.json.html">package.json(5)</a></code> for more
        information.</p>
